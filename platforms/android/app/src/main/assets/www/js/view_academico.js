...
if(retornos['notas']){
    ...
    for(i  in retorno){
        ...
        conteudo_lista += "<div class='align_direita'><ons-button class='minhalinhadigitavel' style='font-size:10pt'><ons-icon icon='fa-list'></ons-icon> Detalhar</ons-button> </div>";
